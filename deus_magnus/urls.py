...
urlpatterns = [
    ...
    path('board_of_director/', BoardOfDirectors.as_view(), name='board_of_director'),
    path('board_of_director_article/<int:pk>/', BoardOfDirectorsArticleDetailView.as_view(), nam="board_of_director_detail"),
